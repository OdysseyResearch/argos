...
- [x] T047 [tooling] Create `.claude/skills/speckit-sync-docs/SKILL.md` — developer tooling skill that propagates spec decisions to `docs/` markdown files; invoked as an extension hook after speckit specify/clarify/plan/analyze steps; not part of the proxy binary or library API
